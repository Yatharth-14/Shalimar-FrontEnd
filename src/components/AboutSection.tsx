...
const milestones: Milestone[] = [
  {
    year: "1985",
    title: "Foundation",
    description: "Shalimar Group established",
  },
  ...
  { year: "2015", title: "Innovation", description: "Smart home technologies" },
  {
    ...
    description: "Our most prestigious project",
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Built meticulously with the urban pioneer in mind, Marbella
                embodies the spirit of those who shatter glass ceilings. From
                trailblazers to go-getters, we're dedicated to those who don't
                just chase dreams, but actively build them each day. At
                Marbella, we celebrate the self-made, offering a world where you
                can revel in your successes and embrace the life you've earned.
              </p>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className="text-2xl font-bold text-[#D4A017] mb-2">
                    {milestone.year}
                  </div>
                  <h4 className="text-lg font-bold text-[#1A3C34] dark:text-[#D4A017] mb-3">
                    {milestone.title}
                  </h4>
