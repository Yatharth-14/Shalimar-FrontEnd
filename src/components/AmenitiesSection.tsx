...
const amenities = [
  {
    icon: Waves,
    title: "Swimming Pool",
    description: "Olympic-size swimming pool with kids' area",
  },
  {
    icon: Dumbbell,
    title: "Gymnasium",
  ...
  },
  {
    icon: Car,
    title: "Parking",
    description: "Covered parking for all residents",
  },
  {
    icon: Shield,
    title: "24/7 Security",
...
const AmenitiesSection = () => {
  ...
  const handleCardClick = (title: string) => {
    trackEvent({
      category: "AmenitiesSection Card",
      action: "Card Clicked AmenitiesSection",
      label: title,
    });
    setIsModalOpen(true);
  };
  ...
  return (
    <>
      <section
        id="amenities"
        className="py-20 px-4 bg-[#F5E6CC] dark:bg-[#2A2520]"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Enjoy a lifestyle of luxury with our comprehensive range of modern
              amenities
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-8">
            {amenities.map((amenity, index) => (
              <Card
                ...
                onClick={() => handleCardClick(amenity.title)}
              >
